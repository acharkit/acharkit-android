...
public class MimeHelper {
     ...
     * @param extension
     */
    private static void add(@Size(min = 1) String mimeType, @Size(min = 1) String extension) {
     ...
     * @return
     */
    public static boolean hasMimeType(@Size(min = 1) String mimeType) {
     ...
     * @return
     */
    public static String guessMimeTypeFromExtension(@Size(min = 1) String extension) {
     ...
     * @return
     */
    public static boolean hasExtension(@Size(min = 1) String extension) {
     ...
     * @return
     */
    public static String guessExtensionFromMimeType(@Size(min = 1) String mimeType) {
