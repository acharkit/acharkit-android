...
public class BottomTabView extends LinearLayout {
     ...
     * @return drawable
     */
    private Drawable changeColorDrawable(ImageView imageView, int color) {
        Drawable drawable = getContext().getResources().getDrawable((Integer) imageView.getTag());
    ...
    private void colorAnimation() {
        for (int i = 0; i < itemLayoutList.size(); i++) {
            if (i == getSelected()) {
                ...
                imageView.setImageDrawable(changeColorDrawable(imageViewList.get(i), getActiveColor()));
                if (textView != null) {
                ...
                final TextView textView = textViewList.get(i);
                final ImageView imageView = imageViewList.get(i);
                imageView.setImageDrawable(changeColorDrawable(imageViewList.get(i), getInActiveColor()));
                if (textView != null) {
    ...
    public void addItem(String title, int icon) {
        ...
        layoutCompat.setPadding(16, 16, 16, 16);
    ...
    private TextView addText(final String title) {
        ...
        textView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (getEnableType() == BottomTab.EnableType.COLOR_ANIMATION)
                    textView.setTextColor(getInActiveColor());
                else
                    textView.setTextColor(Color.darken(backgroundColor, 0.5));
                if (getPathFont() != null)
    ...
    private BottomTab.EnableType getEnableType() {
        return enableType == null ? enableType = BottomTab.EnableType.COLOR_ANIMATION : enableType;
    }
